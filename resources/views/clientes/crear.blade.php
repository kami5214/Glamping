...
<h1 id="demoFont">REGISTRAR CLIENTE</h1>
</div>
<br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="cli_cedula" class="form-control" value="{{old('cli_cedula')}}">
                                        @error('cli_cedula')
...
@enderror
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cli_nombre" class="form-control" value="{{old('cli_nombre')}}">
                                        @error('cli_nombre')
<small style="color:red">{{ $message }}</small>
@enderror
                                    </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cli_apellido" class="form-control" value="{{old('cli_apellido')}}">
                                        @error('cli_apellido')
<small style="color:red">{{ $message }}</small>
@enderror
                                    </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="cli_correo" class="form-control" value="{{old('cli_correo')}}">
                                        @error('cli_correo')
<small style="color:red">{{ $message }}</small>
@enderror
                                    </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="cli_celular" class="form-control" value="{{old('cli_celular')}}">
                                        @error('cli_celular')
<small style="color:red">{{ $message }}</small>
@enderror
                                    </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cli_ciudad" class="form-control" value="{{old('cli_ciudad')}}">
                                        @error('cli_ciudad')
<small style="color:red">{{ $message }}</small>
@enderror
                                    </div>
